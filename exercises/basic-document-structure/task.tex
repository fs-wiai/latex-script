\begin{enumerate}
	\item In eurem \LaTeX{}-Projekt im Ordner \mintinline{latex}{exercises/basic-document-structure} findet ihr eine Datei namens \mintinline{latex}{document-structure.raw.tex}. Öffnet die Datei in eurem präferierten Editor, kopiert den Text und fügt ihn in eine neue Datei ein, die ihr beispielsweise \mintinline{latex}{document-structure-solution.tex} nennt. Packt das neu erstellte Dokument in eine \mintinline{latex}{document}-Umgebung und fügt eine Präambel ein, um euer erstes \LaTeX -Dokument zu erstellen.
